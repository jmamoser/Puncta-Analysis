...
%%% set paths %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
projectpath = 'W:\maar7192\Microscopy data\Live cell\';
imagepath = 'W:\maar7192\Microscopy data\Live cell\';
experimentpath = 'MA81_261\';

biasdir =  'W:\maar7192\Microscopy data\Live cell\MA81_261\Illumination bias\';
cmosoffsetdir = 'Y:\General\Mingyu Background Correctin\20161121_CMOSOFFSET\';
...
name1='CFP-25_'; %nuclear channel
name2='YFP-30_'; %this is always the CDK2sensor channel
puncta_channel = 'mCherry_';
