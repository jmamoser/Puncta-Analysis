function ViewTraces_Panel_CDK2IF_allreddots(row,col,site)
...
experimentpath = 'Mansi\MICROSCOPY DATA\Live-cell imaging\MA61-20160419-mChyBP1-drugs_1556\';
...
frames=1:225; % for Mansi's movie
%frames=1:120;
